            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="statistic-block block">
                        <div class="progress-details d-flex align-items-end justify-content-between">
                            <div class="title">
                                <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>Completed
                                    Orders</strong>
                            </div>
                            <div class="number dashtext-4">{{ $completed_orders }}</div>
                        </div>
                        <div class="progress progress-template">
    ...
    <footer class="footer">
        <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
                ...
                <p class="no-margin-bottom">2025 &copy; Giraffe. Download From <a target="_blank"
