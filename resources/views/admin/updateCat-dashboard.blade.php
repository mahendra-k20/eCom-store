<div class="container category-section">
    <h4 class="display-4 text-white">Edit Category</h4>
    <hr>
    <form class="category-form mt-5" action="{{ route('admin.update_category', base64_encode($category->id)) }}"
        method="post">
        @csrf
        <input type="text" name="category" id="category" value="{{ $category->category_name }}">
        ...
        <tbody>
            ...
            @foreach ($categories as $category)
                <tr>
                    ...
                    <td><a href="{{ route('admin.edit_category', $category->id) }}" class="btn btn-success">Edit</a>
